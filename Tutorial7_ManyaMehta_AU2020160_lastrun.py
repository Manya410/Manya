...
expName = 'Tutorial7_ManyaMehta_AU2020160'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/manyamehta/Desktop/Tutorial7_ManyaMehta_AU2020160_lastrun.py',
...
trials = data.TrialHandler(nReps=5.0, method='random', 
    ...
    trialList=data.importConditions('/Users/manyamehta/Downloads/lab.tut.7_data - Sheet1.csv'),
